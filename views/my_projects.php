            ...
            <div class="modal-content" >
                ...
                <div align="center" class="modal-body" >
                    <div id="new-project-form" class="form-group ">
                        ...
                        <input type="text" class="form-control" id="usr-project-name" style="width: 100%; border-radius: 2px">
                        <p id="error-explanation"></p>
                        <label for="usr-project-about">About Project</label>
                        <textarea class="form-control" id="usr-project-about" style="resize: none; width: 100%; height: 200px; border-radius: 2px">...</textarea>
                    </div>
