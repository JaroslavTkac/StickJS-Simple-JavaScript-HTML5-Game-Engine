...
//TODO ant testinio pabandyti su siuo shaderiu
...
//TODO gal klaida pavadinimuose color uniform ir panasiai
function mainShader() {
    var fragmentShader = getShader(fragmentShaderGLSL, "fragment", webgl);
    var vertexShader = getShader(vertexShaderGLSL, "vertex", webgl);
...
function editorShader() {
    var fragmentShader = getShader(fragmentShaderGLSL, "fragment", webglE);
    var vertexShader = getShader(vertexShaderGLSL, "vertex", webglE);
